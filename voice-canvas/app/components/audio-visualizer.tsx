...
void main() {
  ...
  // Inner circle: subtle glow when idle, red pulse when recording
...
export default function AudioVisualizer({
  ...
  const handleClick = useCallback(
    (e: React.MouseEvent<HTMLCanvasElement>) => {
      ...
      // Click within the inner circle radius (0.26 in shader coords)
      if (dist < 0.26) {
        onCircleClick();
      }
    },
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      gl.texImage2D(
        ...
        gl.RGBA, gl.UNSIGNED_BYTE, texPixels,
      );
